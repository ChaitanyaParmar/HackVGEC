...
{
    $ins_register=mysqli_query($con,"INSERT INTO `registration` (`name`, `email`, `mobile_no`, `address`, `caste`, `sub-caste`, `city`, `state`, `marks`, `Gender`, `category`, `addmission-type`, `image`) VALUES ('$name', '$email', '$phone','$address', '$caste', '$subcaste', '$city', '$state', '$marks', '$gender', '$category', '$edu', '$profile')");
     if($ins_register)
        {
